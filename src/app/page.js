...
export default function PortfolioPage() {
    ...
    const skills = [
        ...
        {
            category: "Backend",
            items: ["Spring Boot", "Spring Security", "JPA / Hibernate", "PostgreSQL", "REST APIs"]
        },
        {
            category: "Frontend",
            items: ["React Native", "React.js", "Next.js", "Tailwind CSS"]
        },
        {
            category: "Tools & Workflow",
            items: ["Docker", "Git", "Cloudinary", "Vercel"]
        }
    ];
    ...
    const projects = [
        {
            title: "Agora",
            type: "Student-Only Mobile Marketplace",
            story: "Campus buying and selling is often fragmented and unsafe. Agora was built to provide a verified, student-only platform for trading items and services within a trusted community.",
        ...
        },
        {
            ...
            story: "Manually tracking expenses is tedious and error-prone. Pulse automates expense tracking by parsing transaction data directly from bank notifications.",
            solution: "Built an Android application that extracts transaction details from system notifications using pattern matching. All data is processed and stored locally using SQLite, ensuring user privacy.",
            features: [
    ...
    return (<main className="bg-white min-h-screen text-slate-900 selection:bg-slate-900 selection:text-white pb-20">
                ...
                >
                    <div className="space-y-4">
                        <p className="text-lg md:text-2xl text-slate-400 max-w-xl leading-snug font-light italic">
                            Designing and building production-ready systems with <br className="hidden md:block"/>
                            <span className="text-white font-medium border-b border-white/10">
                                    Spring Boot
                                </span>{" "}
                            and
                            <span className="text-white font-medium border-b border-white/10 ml-2">
                                    React Native
                                </span>.
                        </p>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-12 relative z-10">
                ...
                <div className="lg:col-span-8 space-y-12 lg:space-y-16">
                    ...
                    <div className="grid grid-cols-1 gap-12 lg:gap-16">
                        ...
                        >
                            I’m a <span className="text-slate-900 font-medium">Full Stack Developer</span> with a strong
                            focus on the
                            <span className="text-slate-900 font-medium"> Spring ecosystem</span>. I design and build
                            production-ready applications using <span className="italic">Java</span>,{" "}
                            <span className="italic">PostgreSQL</span>, and{" "}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-slate-100 pt-12">
                            ...
                            >
                                ...
                                <p className="text-base lg:text-lg text-slate-500 leading-relaxed">
                                    ...
                                    <span className="text-slate-900">system design</span> and{" "}
                                    <span className="text-slate-900">CI/CD workflows</span>, with a focus on
                                    building scalable, maintainable software that holds up in real-world use.
                                </p>
                            </motion.div>
                        </div>
                    </div>
        ...
        <section className="relative w-full">
            {projects.map((p, i) => (<ProjectRow key={i} p={p} i={i}/>))}
        </section>
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-8">
                    <div
                        ...
                        {skills.map((group, idx) => (<SkillCard key={idx} group={group} idx={idx}/>))}
                    </div>
                </div>
            </div>
        </section>
...
function ProjectRow({p, i}) {
    ...
    return (/* FIXED: Height reduced for mobile to keep the experience snappy */
        <div ref={container} className="relative h-[350vh] lg:h-[600vh] bg-white border-t border-slate-100">
            ...
            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                ...
                {/* --- STAGE 2: BILLBOARD --- */}
                {p.title === "Pulse" && (<motion.div style={{opacity: billboardOpacity, scale: billboardScale}}
                                                     className="absolute inset-0 z-0">
                ...
                >
                    <motion.div className="space-y-6 lg:space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-3 lg:gap-4">
                            {p.features?.map((feat, idx) => (<div key={idx} className="flex items-center gap-2">
    ...
    >
        ...
        <div className="relative z-10">
            ...
            <ul className="space-y-4">
                {group.items.map((item, i) => (<motion.li
                    key={item}
                    initial={{opacity: 0.8}}
